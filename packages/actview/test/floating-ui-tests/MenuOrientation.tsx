              ...
              <FloatingPortal>
                ...
                >
                  <div
                    ...
                    className={`Panel${
                      !props.grid && orientation !== 'horizontal'
                        ? ' PanelFlexCol'
                        : ''
                    }${orientation === 'horizontal' ? ' PanelFlexRow' : ''}${
...
/** @internal */
export const HorizontalMenu = defineComponent(function () {
  return () => (
    <>
      <h1 className="Heading">Horizontal menu</h1>
...
/** @internal */
export const VerticalMenu = defineComponent(function () {
  return () => (
    <>
      <h1 className="Heading">Vertical menu</h1>
      <div className="Container">
        <Menu label="Edit">
          <MenuItem label="Undo" onClick={() => console.log('Undo')} />
          <MenuItem label="Redo" />
...
/** @internal */
export const HorizontalMenuWithHorizontalSubmenus = defineComponent(function () {
  return () => (
    <>
      <h1 className="Heading">Horizontal menu with horizontal submenus</h1>
      <div className="Container">
        <Menu label="Edit" orientation="horizontal">
          <MenuItem label="Undo" onClick={() => console.log('Undo')} />
          <MenuItem label="Redo" />
