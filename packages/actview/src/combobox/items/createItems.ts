...
import { findCollectionItem, type ComboboxItemCollection } from '@/combobox/items/itemCollection';
 ...
 *
 * Create static collections at module scope. Wrap dynamic collections in `useMemo()` keyed
 * by their data.
 *
