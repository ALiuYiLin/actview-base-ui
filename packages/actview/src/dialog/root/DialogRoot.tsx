...
export function DialogRoot<Payload>(props: DialogRoot.Props<Payload>) {
  ...
  const store = useDialogRootStore<Payload>(props.handle, {
  ...
  store.useContextCallback('onOpenChange', (...args: any[]) => props.onOpenChange?.(...(args as [boolean, DialogRoot.ChangeEventDetails])));
  ...
  const setOpen = useStableCallback(
    (
      ...
      props.onOpenChange?.(nextOpen, eventDetails as DialogRoot.ChangeEventDetails);
  ...
  return (
    <DialogRootContext.Provider value={store as unknown as DialogRootContext<unknown>}>
      ...
      {shouldRenderInteractions() && <DialogInteractions store={store} modal={modal.value} />}
