...
export type State<Payload> = PopupStoreState<Payload> & {
  ...
  openChangeReason: PreviewCardRoot.ChangeEventReason | null;
  stickIfOpen: boolean;
...
/**
 * The store view that detached handle-backed triggers read from. Both the real `PreviewCardStore` and
...
export class PreviewCardStore<Payload> extends ReactStore<Readonly<State<Payload>>, Context, Selectors> {
  constructor(
  ...
  setOpen(open: boolean, eventDetails: Omit<PreviewCardRoot.ChangeEventDetails, 'preventUnmountOnClose'>) {
