...
export function isOutsideEvent(
  event: FocusEvent | {relatedTarget: EventTarget | null; currentTarget?: EventTarget | null},
  container?: Element,
) {
  const containerElement = container || (event.currentTarget as Element | null) || undefined;
