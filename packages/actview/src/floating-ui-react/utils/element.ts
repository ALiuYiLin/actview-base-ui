...
export function isElementInsideAncestor(element: Element | null, ancestor: Element | null) {
  if (!element || !ancestor) {
    return false;
  }
  return contains(ancestor, element);
}

export { FOCUSABLE_ATTRIBUTE, TYPEABLE_SELECTOR };
