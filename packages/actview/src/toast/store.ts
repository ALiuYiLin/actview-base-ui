...
import { generateId } from '@base-ui/actview-utils/generateId';
...
export class ToastStore extends ActviewStore<Readonly<State>, Record<string, never>, Selectors> {
